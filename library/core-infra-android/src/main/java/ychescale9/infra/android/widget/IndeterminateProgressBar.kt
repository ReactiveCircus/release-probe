package ychescale9.infra.android.widget
...
/**
 * This is a UI test friendly implementation of an indeterminate ProgressBar,
...
constructor(context: Context, attrs: AttributeSet? = null) : ProgressBar(context, attrs) {
    ...
    private val isAnimationOff: Boolean
        get() = Settings.Global.getFloat(context.contentResolver, Settings.Global.ANIMATOR_DURATION_SCALE, 1f) == 0f
